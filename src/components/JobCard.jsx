    ...
    >
      <div className="glass rounded-3xl overflow-hidden shadow-2xl max-h-[500px] flex flex-col">
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1">
          {/* Job Description */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-1 text-sm">About the Role</h3>
            <p className="text-gray-600 text-xs leading-relaxed">{job.description}</p>
          </div>

          {/* Requirements */}
          <div className="bg-gray-50 rounded-lg p-3">
            <h3 className="text-xs font-semibold text-gray-900 mb-1">What We're Looking For</h3>
            <p className="text-gray-700 text-xs">{job.requirements}</p>
          </div>
          ...
          <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
            <h3 className="text-xs font-semibold text-amber-900 mb-1 uppercase tracking-wide flex items-center gap-2">
